...
- Regla adaptativa de recorte lateral en mediopié para reducir contaminación por sombras laterales en anchos/arco, con detección automática de basura, agresividad suavizada, salvaguarda anti sobre-recorte y tope de agresión (priorizando conservar mediopié anatómico).
